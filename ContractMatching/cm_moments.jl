...
function compute_moments(sol, para)
    ...
    @unpack ρ, β1, β2, vec_β, β1_ex, β2_ex, vec_β_ex, vec_i, vec_e, κ0, κ1, κ0_ex, κ1_ex = para;

    # expected matching values of all success matches
    mat_mv = fill(0.0, num_i, num_e);
    arr_mv = fill(0.0, num_i, num_e, num_i);

    mv_in(i, e, c, dummies) = g(i, e, ρ) * h(c, dummies, β1, β2, vec_β)
    mv_ex(i, e, c, dummies) = g(i, e, ρ) * h(c, dummies, β1_ex, β2_ex, vec_β_ex)
    ...
    for ii in 1:num_i, ei in 1:num_e
        ...
        mat_mv[ii, ei] = mv_in(i,e,c,dummies)
    end
    ...
    for ii in 1:num_i, ei in 1:num_e, iotai in 1:num_i
        ...
        arr_mv[ii, ei, iotai] = mv_ex(i,e,c,dummies)
    end
    ...
    arr_successProb = cdf.(Φ, κ0_ex .+ κ1_ex * arr_mv)
    ...
    return [E_tau, V_tau, E_inprob, V_inprob, E_cStarIn, E_cStarEx, V_cStarIn, V_cStarEx, E_D1In, E_D1Ex, E_D2In, E_D2Ex, Cov_cStar_D1In, Cov_cStar_D1Ex, Cov_cStar_D2In, Cov_cStar_D2Ex, Cov_D1_D2In, Cov_D1_D2Ex, Cov_tau_cStarIn, Cov_tau_cStarEx, Cov_tau_D1In, Cov_tau_D1Ex, Cov_tau_D2In, Cov_tau_D2Ex, E_successProbIn, E_successProbEx, Cov_successProb_cStarIn, Cov_successProb_cStarEx, Cov_successProb_D1In, Cov_successProb_D1Ex, Cov_successProb_D2In, Cov_successProb_D2Ex, Cov_inprob_successProb, Cov_tau_successProbIn, Cov_tau_successProbEx]
end
